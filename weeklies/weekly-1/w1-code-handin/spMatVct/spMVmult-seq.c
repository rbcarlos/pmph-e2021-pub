...
static void futrts_cli_entry_main(struct futhark_context *ctx)
{
    ...
    errno = 0;
    if (read_array(stdin, &i64_info, (void **) &read_arr_0, read_shape_0, 1) !=
        0)
    ...
    errno = 0;
    if (read_array(stdin, &f32_info, (void **) &read_arr_1, read_shape_1, 1) !=
        0)
        futhark_panic(1, "Cannot read input #%d of type %s%s (errno: %s).\n", 1,
    ...
    errno = 0;
    if (read_array(stdin, &i64_info, (void **) &read_arr_2, read_shape_2, 1) !=
        0)
        futhark_panic(1, "Cannot read input #%d of type %s%s (errno: %s).\n", 2,
                      "[]", i64_info.type_name, strerror(errno));
    ...
    if (perform_warmup) {
        ...
        assert((read_value_0 = futhark_new_i64_1d(ctx, read_arr_0,
                                                  read_shape_0[0])) != NULL);
        assert((read_value_1 = futhark_new_f32_1d(ctx, read_arr_1,
                                                  read_shape_1[0])) != NULL);
        assert((read_value_2 = futhark_new_i64_1d(ctx, read_arr_2,
                                                  read_shape_2[0])) != NULL);
...
static int futrts_main(struct futhark_context *ctx,
                       struct memblock *out_mem_p_4312,
                       struct memblock mat_inds_mem_4286,
                       struct memblock mat_vals_mem_4287,
                       struct memblock shp_mem_4288,
                       struct memblock vct_mem_4289, int64_t n_4253,
                       int64_t m_4254, int64_t implz2080U_4255);
                       ...
                       int64_t m_4254, int64_t implz2080U_4255)
{
    ...
    int err = 0;
    size_t mem_4291_cached_sizze_4313 = 0;
    char *mem_4291 = NULL;
    struct memblock out_mem_4307;
    
    out_mem_4307.references = NULL;
    
    int64_t bytes_4290 = (int64_t) 4 * m_4254;
    
    if (mem_4291_cached_sizze_4313 < (size_t) bytes_4290) {
        mem_4291 = realloc(mem_4291, bytes_4290);
        mem_4291_cached_sizze_4313 = bytes_4290;
    }
    for (int64_t i_4308 = 0; i_4308 < m_4254; i_4308++) {
        ((float *) mem_4291)[i_4308] = 0.0F;
    }
    
    int64_t res_4262;
    int64_t offset_4265 = (int64_t) 0;
    
    for (int64_t i_4263 = 0; i_4263 < m_4254; i_4263++) {
        int64_t row_len_4266 = ((int64_t *) shp_mem_4288.mem)[i_4263];
        float sum_4267;
        float sum_4269 = 0.0F;
        
        for (int64_t j_4268 = 0; j_4268 < row_len_4266; j_4268++) {
            int64_t i_4270 = add64(offset_4265, j_4268);
            bool x_4271 = sle64((int64_t) 0, i_4270);
            bool y_4272 = slt64(i_4270, n_4253);
            bool bounds_check_4273 = x_4271 && y_4272;
            bool index_certs_4274;
            
            if (!bounds_check_4273) {
                ctx->error =
                    msgprintf("Error: %s%lld%s%lld%s\n\nBacktrace:\n%s",
                              "Index [", i_4270,
                              "] out of bounds for array of shape [", n_4253,
                              "].",
                              "-> #0  spMVmult-seq.fut:24:15-28\n   #1  spMVmult-seq.fut:35:3-46\n   #2  spMVmult-seq.fut:32:1-35:46\n");
                if (memblock_unref(ctx, &out_mem_4307, "out_mem_4307") != 0)
                    return 1;
                return 1;
            }
            
            float x_4275 = ((float *) mat_vals_mem_4287.mem)[i_4270];
            int64_t i_4276 = ((int64_t *) mat_inds_mem_4286.mem)[i_4270];
            bool x_4277 = sle64((int64_t) 0, i_4276);
            bool y_4278 = slt64(i_4276, implz2080U_4255);
            bool bounds_check_4279 = x_4277 && y_4278;
            bool index_certs_4280;
            
            if (!bounds_check_4279) {
                ctx->error =
                    msgprintf("Error: %s%lld%s%lld%s\n\nBacktrace:\n%s",
                              "Index [", i_4276,
                              "] out of bounds for array of shape [",
                              implz2080U_4255, "].",
                              "-> #0  spMVmult-seq.fut:24:30-48\n   #1  spMVmult-seq.fut:35:3-46\n   #2  spMVmult-seq.fut:32:1-35:46\n");
                if (memblock_unref(ctx, &out_mem_4307, "out_mem_4307") != 0)
                    return 1;
                return 1;
            }
            
            float y_4281 = ((float *) vct_mem_4289.mem)[i_4276];
            float y_4282 = x_4275 * y_4281;
            float loopres_4283 = sum_4269 + y_4282;
            float sum_tmp_4311 = loopres_4283;
            
            sum_4269 = sum_tmp_4311;
        }
        sum_4267 = sum_4269;
        ((float *) mem_4291)[i_4263] = sum_4267;
        
        int64_t offset_4285 = add64(offset_4265, row_len_4266);
        int64_t offset_tmp_4310 = offset_4285;
        
        offset_4265 = offset_tmp_4310;
    }
    res_4262 = offset_4265;
    
    struct memblock mem_4305;
    
    mem_4305.references = NULL;
    if (memblock_alloc(ctx, &mem_4305, bytes_4290, "mem_4305")) {
        err = 1;
        goto cleanup;
    }
    memmove(mem_4305.mem + (int64_t) 0, mem_4291 + (int64_t) 0, m_4254 *
            (int64_t) sizeof(float));
    if (memblock_set(ctx, &out_mem_4307, &mem_4305, "mem_4305") != 0)
        return 1;
    (*out_mem_p_4312).references = NULL;
    if (memblock_set(ctx, &*out_mem_p_4312, &out_mem_4307, "out_mem_4307") != 0)
        return 1;
    if (memblock_unref(ctx, &mem_4305, "mem_4305") != 0)
        return 1;
    if (memblock_unref(ctx, &out_mem_4307, "out_mem_4307") != 0)
        return 1;
                       ...
                       struct futhark_f32_1d *in3)
{
    ...
    mat_inds_mem_4286.references = NULL;
    
    struct memblock mat_vals_mem_4287;
    
    mat_vals_mem_4287.references = NULL;
    
    struct memblock shp_mem_4288;
    
    shp_mem_4288.references = NULL;
    
    struct memblock vct_mem_4289;
    
    vct_mem_4289.references = NULL;
    
    int64_t n_4253;
    int64_t m_4254;
    int64_t implz2080U_4255;
    struct memblock out_mem_4307;
    ...
    lock_lock(&ctx->lock);
    mat_inds_mem_4286 = in0->mem;
    n_4253 = in0->shape[0];
    mat_vals_mem_4287 = in1->mem;
    n_4253 = in1->shape[0];
    shp_mem_4288 = in2->mem;
    m_4254 = in2->shape[0];
    vct_mem_4289 = in3->mem;
    implz2080U_4255 = in3->shape[0];
    if (!(n_4253 == in0->shape[0] && (n_4253 == in1->shape[0] && (m_4254 ==
                                                                  in2->shape[0] &&
                                                                  implz2080U_4255 ==
                                                                  in3->shape[0])))) {
        ret = 1;
        ...
        ret = futrts_main(ctx, &out_mem_4307, mat_inds_mem_4286,
                          mat_vals_mem_4287, shp_mem_4288, vct_mem_4289, n_4253,
                          m_4254, implz2080U_4255);
        if (ret == 0) {
            assert((*out0 =
                    (struct futhark_f32_1d *) malloc(sizeof(struct futhark_f32_1d))) !=
                NULL);
            (*out0)->mem = out_mem_4307;
            (*out0)->shape[0] = m_4254;
        }
    }
    lock_unlock(&ctx->lock);
