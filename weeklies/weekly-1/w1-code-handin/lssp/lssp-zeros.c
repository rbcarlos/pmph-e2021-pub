...
static int futrts_main(struct futhark_context *ctx,
                       int32_t *out_scalar_out_4208,
                       struct memblock xs_mem_4203, int64_t implz2080U_4181);
                       ...
                       struct memblock xs_mem_4203, int64_t implz2080U_4181)
{
    ...
    int err = 0;
    int32_t scalar_out_4204;
    int32_t best_len_4183;
    int32_t best_len_4184;
    int32_t best_len_4185;
    int32_t best_len_4187;
    int32_t curr_len_4188;
    int32_t prev_4189;
    
    best_len_4187 = 0;
    curr_len_4188 = 0;
    prev_4189 = 0;
    for (int64_t i_4186 = 0; i_4186 < implz2080U_4181; i_4186++) {
        int32_t x_4190 = ((int32_t *) xs_mem_4203.mem)[i_4186];
        bool cond_4191 = i_4186 == (int64_t) 0;
        bool cond_4192 = prev_4189 == 0;
        bool defunc_1_pred2_res_t_res_4193 = x_4190 == 0;
        bool x_4194 = cond_4192 && defunc_1_pred2_res_t_res_4193;
        bool x_4195 = !cond_4191;
        bool y_4196 = x_4194 && x_4195;
        bool connected_4197 = cond_4191 || y_4196;
        bool x_4198 = defunc_1_pred2_res_t_res_4193 && connected_4197;
        int32_t curr_len_4199;
        
        if (x_4198) {
            int32_t curr_len_t_res_4200 = add32(1, curr_len_4188);
            
            curr_len_4199 = curr_len_t_res_4200;
        } else {
            int32_t curr_len_f_res_4201 =
                    btoi_bool_i32(defunc_1_pred2_res_t_res_4193);
            
            curr_len_4199 = curr_len_f_res_4201;
        }
        
        int32_t max_res_4202 = smax32(best_len_4187, curr_len_4199);
        int32_t best_len_tmp_4205 = max_res_4202;
        int32_t curr_len_tmp_4206 = curr_len_4199;
        int32_t prev_tmp_4207 = x_4190;
        
        best_len_4187 = best_len_tmp_4205;
        curr_len_4188 = curr_len_tmp_4206;
        prev_4189 = prev_tmp_4207;
    }
    best_len_4183 = best_len_4187;
    best_len_4184 = curr_len_4188;
    best_len_4185 = prev_4189;
    scalar_out_4204 = best_len_4183;
    *out_scalar_out_4208 = scalar_out_4204;
...
int futhark_entry_main(struct futhark_context *ctx, int32_t *out0, const
                       struct futhark_i32_1d *in0)
{
    struct memblock xs_mem_4203;
    
    xs_mem_4203.references = NULL;
    
    int64_t implz2080U_4181;
    int32_t scalar_out_4204;
    int ret = 0;
    
    lock_lock(&ctx->lock);
    xs_mem_4203 = in0->mem;
    implz2080U_4181 = in0->shape[0];
    if (!(implz2080U_4181 == in0->shape[0])) {
        ret = 1;
        if (!ctx->error)
            ctx->error =
                msgprintf("Error: entry point arguments have invalid sizes.\n");
    } else {
        ret = futrts_main(ctx, &scalar_out_4204, xs_mem_4203, implz2080U_4181);
        if (ret == 0) {
            *out0 = scalar_out_4204;
        }
    }
    lock_unlock(&ctx->lock);
    return ret;
